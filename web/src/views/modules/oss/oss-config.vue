  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <template v-else-if="dataForm.type === 4">
        <el-form-item label="域名">
          <el-input v-model="dataForm.localServerDomain" placeholder="本地绑定的域名"></el-input>
        </el-form-item>
        <el-form-item label="路径前缀">
          <el-input v-model="dataForm.localServerPrefix" placeholder="不设置默认为空"></el-input>
        </el-form-item>
        <el-form-item label="保存路径">
          <el-input v-model="dataForm.localServerPath" placeholder="上传的绝对路径如：/hyperf-upload"></el-input>
        </el-form-item>
      </template>
    </el-form>
